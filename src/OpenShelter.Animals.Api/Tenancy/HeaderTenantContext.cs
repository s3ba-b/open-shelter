...
/// <summary>
/// Placeholder tenant resolution for M0: reads the tenant id from a request header.
/// M1 replaces this with resolution from an authenticated tenant claim; the
/// <see cref="ITenantContext"/> contract and everything built on it (query filters,
/// seeded data) stays unchanged.
/// </summary>
